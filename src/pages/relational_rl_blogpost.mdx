...
$\begin{aligned}
    ...
    &= - ||s_h - s_o||_2 + c_1 \cdot \mathbb{I}_{|| s_h - s_o||_2  < \epsilon} \cdot \mathbb{I}_{s_c} - c_2 \cdot \mathbb{I}_{s_c} \cdot \exp{\frac{||s_o - s_g||^2}{c_3}} 
\end{aligned}$
...
![rel_rl_images/Untitled.png](rel_rl_images/Untitled.png)
...
![rel_rl_images/Towards_Practical_Multi-object_Manipulation_using_Relational.gif](rel_rl_images/Towards_Practical_Multi-object_Manipulation_using_Relational.gif)
...
![rel_rl_images/Untitled%201.png](rel_rl_images/Untitled%201.png)
...
![rel_rl_images/Untitled%202.png](rel_rl_images/Untitled%202.png)
...
![rel_rl_images/Untitled%203.png](rel_rl_images/Untitled%203.png)
...
![rel_rl_images/Untitled%204.png](rel_rl_images/Untitled%204.png)
...
[rel_rl_images/singulation.mp4](rel_rl_images/singulation.mp4)

Singulation

[rel_rl_images/pushing.mp4](rel_rl_images/pushing.mp4)

Pushing while grasping

[rel_rl_images/pick2place2.mp4](rel_rl_images/pick2place2.mp4)
...
![rel_rl_images/Untitled%205.png](rel_rl_images/Untitled%205.png)
...
- Talk describing the paper delivered virtually at ICRA 2020.
    ...
    [rel_rl_images/ICRA2020_presentation_v9_recording.m4v](rel_rl_images/ICRA2020_presentation_v9_recording.m4v)

- Project Slides

    [ICRA2020 Slides](rel_rl_images/ICRA2020_presentation_v9_no_presenter.pdf)
...
2. V. Zambaldi, D. Raposo, A. Santoro, V. Bapst, Y. Li, I. Babuschkin,
K. Tuyls, D. Reichert, T. Lillicrap, E. Lockhart, et al., “[Deep reinforcement learning with relational inductive biases](https://openreview.net/pdf?id=HkxaFoC9KQ),” International Conference on Learning Representations, 2019.
...
4. Y. Duan, M. Andrychowicz, B. Stadie, O. Jonathan Ho, J. Schneider,
I. Sutskever, P. Abbeel, and W. Zaremba, “[One-shot imitation learning](http://papers.nips.cc/paper/6709-one-shot-imitation-learning.pdf),” in Advances in Neural Information Processing Systems, 2017.
5. M. Janner, S. Levine, W. T. Freeman, J. B. Tenenbaum, C. Finn, and
J. Wu, “[Reasoning about physical interactions with object-oriented prediction and planning](https://arxiv.org/abs/1812.10972),” in International Conference on Learning Representations, 2019.
