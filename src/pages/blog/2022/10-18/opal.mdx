...
<FigureRow>
    <Figure width="50%"><img src="opal/Untitled.png"/></Figure>
    <Figure width="28%">
        <img src="opal/Screen_Shot_2021-03-16_at_11.54.58_PM.png"/>
        <figcaption>(Taken from berkeley CS 285)</figcaption>
    </Figure>
</FigureRow>
