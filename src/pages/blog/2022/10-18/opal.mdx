...
![tab1-crop.bmp](opal/tab1-crop.bmp)
...
![antmaze_medium_slow.gif](opal/antmaze_medium_slow.gif)

![antmaze_large_slow.gif](opal/antmaze_large_slow.gif)
...
![tab2-crop.bmp](opal/tab2-crop.bmp)
...
![opal/pick-place.gif](opal/pick-place.gif)

![opal/mt10.gif.gif](opal/mt10.gif.gif)

![tab3-crop.bmp](opal/tab3-crop.bmp)
